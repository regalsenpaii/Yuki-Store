    ...
    return new Promise((resolve) => {
        ...
        reader.onload = async () => {
            try {
                ...
                // 2. Mengarahkan URL target ke endpoint API lokal Vercel
                ...
                // 4. KIRIM KE VERCEL (Aman & Bersih tanpa token bocor di client)
                ...
                // 5. Mengambil data URL kembalian yang dikirim oleh api/upload.js
                if (resData.success) {
                    resolve(resData.download_url);
                } else {
                    throw new Error(resData.error || 'Gagal tanpa pesan');
                }
            } catch (e) {
